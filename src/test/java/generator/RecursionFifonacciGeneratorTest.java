...
public class RecursionFifonacciGeneratorTest {
    private FibonacciGenerator generator;

    @Before
    public void setUp() throws Exception {
        generator = new RecursionFifonacciGenerator();
    }
    ...
    public void testGeneratorWithConfiguration() throws Exception {
        FibonacciGenerator generatorWithConfiguration = new RecursionFifonacciGenerator(
